        ...
        area(Processing)
        {
            ...
            action("Schedule Follow-Up")
            {
                ...
                begin
                    ...
                    ActivityRec."Activity Type" :=
                        ActivityRec."Activity Type"::"Follow-Up";

                    ActivityRec."Activity Date" :=
                        Today;

                    ActivityRec.Subject :=
                        'Lead Follow-Up';

                    ActivityRec."Assigned To" :=
                        Rec."Salesperson Code";

                    ActivityRec."Due Date" :=
                    ...
                    Message(
                        'Follow-up has been scheduled for %1.',
                        Rec."Next Follow-Up Date");
                end;
            }
            ...
            action("Create Contact")
            {
                ...
                begin
                    ...
                    // Create Contact
                    ContactNo :=
                        LeadContactMgt.CreateContactFromLead(Rec);
